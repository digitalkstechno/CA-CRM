        ...
        <form onSubmit={submit} className="space-y-4">
          <div>
            ...
            <input value={name} onChange={e => setName(e.target.value)} maxLength={22}
              className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-blue-100" placeholder="e.g. Ravi Sojitra" required />
          </div>
